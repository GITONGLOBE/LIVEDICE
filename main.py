"""
LIVEDICE MAIN MODULE
Main entry point for LIVEDICE game.

MODIFIED: 2025-10-29
CHANGES: Added game loop to allow returning to startup menu
- Game now loops back to startup menu when EXIT GAME is clicked
- Fixed game configuration handling
WHY: Allow players to return to startup menu from in-game
TESTING: Start game, click X button, click EXIT GAME - should return to menu
"""
...
def main():
    """Main game loop - allows returning to startup menu"""
    pygame.init()
